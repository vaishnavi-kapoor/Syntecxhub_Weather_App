  ...
  return (
    <div className='weather'>
      <div className="search-bar">
        ...
        <img src={search1} alt='' onClick={() => search(inputRef.current.value)} />
      </div>

      {weatherData? <>
      <img src={weatherData?.icon || clear} alt="Weather Icon" className='weather-icon' />
      ...
      <div className='weather-data'>
        ...
        <div className="col">
          <img src={wind} alt='' />
          <div>
            <p>{weatherData?.windSpeed || 3}Km/hr</p>
